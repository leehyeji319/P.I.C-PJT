						...
						<c:forEach items="${resultList}" var="result" varStatus="status">
							<article class="feature left">
								...
								<div class="content">
									...
									<ul class="actions">
										<li>
											<a href="javascript:void(0);" id="PICOff_${result.tourist_idx}" class="button special" onclick="javascript:fn_pic('N', '${result.tourist_idx}');">P.I.C off</a>
										</li>
									</ul>
								</div>
							</article>
			...
			function fn_pic(pic_yn, tourist_idx){
				...
				$.ajax({
				    ...
				    success : function (res) {
				    	location.replace("/pic/user/selectUserMyPageList.do");
				    },
				    error: function (xhr) {
				    }
				});
